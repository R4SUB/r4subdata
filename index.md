...
[![CRAN
status](https://www.r-pkg.org/badges/version/r4subdata)](https://CRAN.R-project.org/package=r4subdata)
[![CRAN
downloads](https://cranlogs.r-pkg.org/badges/r4subdata)](https://CRAN.R-project.org/package=r4subdata)
...
submission readiness ecosystem.

Designed for demos, vignettes, and package testing – like `nycflights13`
or `palmerpenguins`.
